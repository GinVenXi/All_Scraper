...
from Models.Scraper.Tencent.Auto import Model_Scraper_Tencent_Auto
from Service.Abstract import Service_Abstract

class Service_Tencent_Auto(Service_Abstract):

    def __init__(self):
        super(Service_Tencent_Auto, self).__init__()
    ...
    def scrape(self, url):
        self.scraper = Model_Scraper_Tencent_Auto()
        try:
