...
from Models.Scraper.Tencent.Base import Model_Scraper_Tencent_Base
from Service.Abstract import Service_Abstract

class Service_Tencent_Base(Service_Abstract):

    def __init__(self):
        super(Service_Tencent_Base, self).__init__()
    ...
    def scrape(self, url):
        self.scraper = Model_Scraper_Tencent_Base()
        try:
