...
from Models.Scraper.Tencent.Gongyi import Model_Scraper_Tencent_Gongyi
from Service.Abstract import Service_Abstract

class Service_Tencent_Gongyi(Service_Abstract):

    def __init__(self):
        super(Service_Tencent_Gongyi, self).__init__()
    ...
    def scrape(self, url):
        self.scraper = Model_Scraper_Tencent_Gongyi()
        try:
