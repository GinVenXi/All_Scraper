...
#############################################################
'''
class Model_Processor_TopReviewer_Couk(Model_Processor):
        ...
        for i in range(begin, end):
            ...
            if (reviewerDom):
                ...
                try:
                    ...
                    if (rankDom):
                        item['rank'] = self.formatNumber(rankDom[0], "co.uk")
                        # print (item['rank'])
                ...
                try:
                    ...
                    if (imgDom):
                        item['profile_image_url'] = self.formatImage(imgDom[0])
                ...
                try:
                    ...
                    if (totalReviewsDom):
                        item['review_count'] = self.formatNumber(totalReviewsDom[0], "co.uk")
                ...
                try:
                    ...
                    if (helpfulVotesDom):
                        item['helpful_vote_count'] = self.formatNumber(helpfulVotesDom[0], "co.uk")
                ...
                try:
                    ...
                    if (percentHelpfulDom):
                        item['helpful_vote_ratio'] = self.formatNumber(percentHelpfulDom[0], "co.uk")
