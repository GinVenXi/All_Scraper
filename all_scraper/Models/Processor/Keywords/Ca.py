...
class Model_Processor_Keywords_Ca(Model_Processor):
    def __init__(self):
        pass
    ...
    def process(self, html, page_id=1):
        ...
        try:
            ...
            if (listDoms):
                ...
                for itemDom in listDoms:
                    ...
                    try:
                        ...
                        if (price):
                            if (Model_Processor().formatNumber(price[0], "ca").isdigit()):
                                item['price'] = Model_Processor().formatNumber(price[0], "ca")
                        else:
                    ...
                    try:
                        ...
                        if (list_price):
                            if (Model_Processor().formatNumber(list_price[0], "ca").isdigit()):
                                item['list_price'] = Model_Processor().formatNumber(list_price[0], "ca")
                    except:
                    ...
                    try:
                        ...
                        if (rating):
                            item['rating'] = Model_Processor().formatRating(rating[0], "ca")
                    except:
                        print ("rating error")
                    ...
                    try:
                        ...
                        if (review_count):
                            count = Model_Processor().formatNumber(review_count[0], "ca")
                            if (count.isdigit()):
                            ...
                            if (review_count):
                                ...
                                review_count = itemDom.xpath("div//*[contains(@class, 'a-col-right')]//div[@class='a-column a-span7']/div[@class='a-row a-spacing-mini'][1]/a/text()")
                                if (review_count):
                                    count = Model_Processor().formatNumber(review_count[0], "ca")
                                    if (count.isdigit()):
                                        item['review_count'] = count
                                # print (itemDom.xpath("div//*[contains(@class, 'a-col-right')]//div[@class='a-column a-span7']/div[@class='a-row a-spacing-mini'][1]/a/text()"))
                    except:
                            ...
                            for itemDom in rightListDom:
                                ...
                                if (linkDoms):
                                    ...
                                    if not item['asin']:
                                        ...
                                        if (review_countDom):
                                            item['review_count'] = Model_Processor().formatNumber(review_countDom[0], "ca")
                                ...
                                try:
                                    ...
                                    if (priceDom):
                                        if (Model_Processor().formatNumber(priceDom[0], "ca").isdigit()):
                                            item['price'] = Model_Processor().formatNumber(priceDom[0], "ca")
                                except:
                                ...
                                try:
                                    ...
                                    if (list_priceDom):
                                        if (Model_Processor().formatNumber(list_priceDom[0], "ca").isdigit()):
                                            item['list_price'] = Model_Processor().formatNumber(list_priceDom[0], "ca")
                                except:
                                ...
                                try:
                                    ...
                                    if (ratingDom):
                                        item['rating'] = Model_Processor().formatRating(ratingDom[0], "ca")
                                except:
            ...
            if (totalDom):
                # 总数 >1
                try:
                    total = Model_Processor().formatNumber(totalDom[0].split(" ")[2], "ca")
                except:
                    total = Model_Processor().formatNumber(totalDom[0].split(" ")[0], "ca")
                if (total.isdigit()):
                    total = {"total": total}
                    data.append(total)
                else:
