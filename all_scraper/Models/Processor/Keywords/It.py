...
class Model_Processor_Keywords_It(Model_Processor):
    def __init__(self):
        pass
    ...
    def process(self, html, page_id=1):
        ...
        try:
            ...
            if (listDoms):
                ...
                for itemDom in listDoms:
                    ...
                    try:
                        ...
                        if (price):
                            if (Model_Processor().formatNumber(price[0], "it").isdigit()):
                                item['price'] = Model_Processor().formatNumber(price[0], "it")
                        else:
                    ...
                    try:
                        ...
                        if (list_price):
                            if (Model_Processor().formatNumber(list_price[0], "it").isdigit()):
                                item['list_price'] = Model_Processor().formatNumber(list_price[0], "it")
                    except:
                    ...
                    try:
                        ...
                        if (rating):
                            item['rating'] = Model_Processor().formatRating(rating[0], "it")
                    except:
                        print ("rating error")
                    ...
                    try:
                        ...
                        if (review_count):
                            count = Model_Processor().formatNumber(review_count[0], "it")
                            if (count.isdigit()):
                            ...
                            for itemDom in rightListDom:
                                ...
                                if (linkDoms):
                                    ...
                                    if not item['asin']:
                                        ...
                                        if (review_countDom):
                                            item['review_count'] = Model_Processor().formatNumber(review_countDom[0], "it")
                                ...
                                try:
                                    ...
                                    if (priceDom):
                                        if (Model_Processor().formatNumber(priceDom[0], "it").isdigit()):
                                            item['price'] = Model_Processor().formatNumber(priceDom[0], "it")
                                except:
                                ...
                                try:
                                    ...
                                    if (list_priceDom):
                                        if (Model_Processor().formatNumber(list_priceDom[0], "it").isdigit()):
                                            item['list_price'] = Model_Processor().formatNumber(list_priceDom[0], "it")
                                except:
                                ...
                                try:
                                    ...
                                    if (ratingDom):
                                        item['rating'] = Model_Processor().formatRating(ratingDom[0], "it")
                                except:
            ...
            if (totalDom):
                ...
                try:
                    total = Model_Processor().formatNumber(totalDom[0].split("dei")[1].strip().split("risultati")[0].replace(".", "").strip(), "it")
                except:
                    total = Model_Processor().formatNumber(totalDom[0].split(" ")[0], "it")
                if (total.isdigit()):
                    total = {"total": total}
                    data.append(total)
                else:
                ...
                if (totalDom):
                    if (totalDom[0] == "0" and totalDom[1] == "risultati"):
                        print totalDom[0]
                        print totalDom[1]
                        total = {"total": "0"}
                        data.append(total)
