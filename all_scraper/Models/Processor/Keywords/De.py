...
#############################################################
'''
class Model_Processor_Keywords_De(Model_Processor):
    ...
    def process(self, html, page_id=1):
        ...
        try:
            ...
            if (listDoms):
                ...
                for itemDom in listDoms:
                    ...
                    try:
                        ...
                        if (price):
                            if (Model_Processor().formatNumber(price[0], "de").isdigit()):
                            ...
                            if (price):
                                ...
                                if (price):
                                    ...
                                    # a-color-price
                                    price = itemDom.xpath("div//*[contains(@class, 'a-color-price')]/text()")
                                    if (price):
                                        if (Model_Processor().formatNumber(price[0], "de").isdigit()):
                                            item['price'] = Model_Processor().formatNumber(price[0], "de")
                                    else:
                    ...
                    try:
                        ...
                        if (list_price):
                            if (Model_Processor().formatNumber(list_price[0], "de").isdigit()):
                            ...
                            for itemDom in rightListDom:
                                ...
                                if (linkDoms):
                                    ...
                                    if not item['asin']:
                                        ...
                                        if (review_countDom):
                                            item['review_count'] = Model_Processor().formatNumber(review_countDom[0], "de")
                                ...
                                try:
                                    ...
                                    if (priceDom):
                                        if (Model_Processor().formatNumber(priceDom[0], "de").isdigit()):
                                            item['price'] = Model_Processor().formatNumber(priceDom[0], "de")
                                except:
                                ...
                                try:
                                    ...
                                    if (list_priceDom):
                                        if (Model_Processor().formatNumber(list_priceDom[0], "de").isdigit()):
                                            item['list_price'] = Model_Processor().formatNumber(list_priceDom[0], "de")
                                except:
                                ...
                                try:
                                    ...
                                    if (ratingDom):
                                        item['rating'] = Model_Processor().formatRating(ratingDom[0], "de")
                                except:
            ...
            if (totalDom):
                # 总数 >1
                total = Model_Processor().formatNumber(totalDom[0].split(" ")[2], "de")
                if (total.isdigit()):
                    total = {"total": total}
                    data.append(total)
                else:
                    # 总数 ==1
                    total = Model_Processor().formatNumber(totalDom[0].split(" ")[0], "de")
                    if (total.isdigit()):
                        total = {"total": total}
                        data.append(total)
                ...
                if (totalDom):
                    if (totalDom[1] == "0" and totalDom[2] == "Ergebnisse"):
                        print totalDom[1]
                        print totalDom[2]
                        total = {"total": "0"}
                        data.append(total)
