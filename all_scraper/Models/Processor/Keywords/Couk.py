...
#############################################################
'''
class Model_Processor_Keywords_Couk(Model_Processor):
    ...
    def process(self, html, page_id=1):
        ...
        try:
            ...
            listDom3 = tree.xpath('//*[@id="btfPreResults"]/ul/li')
            ...
            if (listDoms):
                ...
                for itemDom in listDoms:
                        ...
                        if (bestsellerDom):
                            if (bestsellerDom[0] == "Best Seller"):
                                ...
                                if (bestseller_node_id):
                                    ...
                                    bestseller_id = \
                                    bestseller_node_id[0].strip().split("bestsellers/")[1].strip().split("/")[1].strip()
                    ...
                    try:
                        ...
                        if (price):
                            if (Model_Processor().formatNumber(price[0], "co.uk").isdigit()):
                                item['price'] = Model_Processor().formatNumber(price[0], "co.uk")
                        else:
                    ...
                    try:
                        ...
                        if (list_price):
                            if (Model_Processor().formatNumber(list_price[0], "co.uk").isdigit()):
                                item['list_price'] = Model_Processor().formatNumber(list_price[0], "co.uk")
                    except:
                    ...
                    try:
                        ...
                        if (rating):
                            item['rating'] = Model_Processor().formatRating(rating[0], "co.uk")
                            # print item['rating']
                    except:
                        print ("rating error")
                    ...
                    try:
                        ...
                        if (review_count):
                            count = Model_Processor().formatNumber(review_count[0], "co.uk")
                            if (count.isdigit()):
                            ...
                            for itemDom in rightListDom:
                                ...
                                if (linkDoms):
                                    ...
                                    if not item['asin']:
                                        ...
                                        if (review_countDom):
                                            item['review_count'] = Model_Processor().formatNumber(review_countDom[0], "co.uk")
                                # 获取广告图片
                                try:
                                ...
                                try:
                                    ...
                                    if (priceDom):
                                        if (Model_Processor().formatNumber(priceDom[0], "co.uk").isdigit()):
                                            item['price'] = Model_Processor().formatNumber(priceDom[0], "co.uk")
                                except:
                                ...
                                try:
                                    ...
                                    if (list_priceDom):
                                        if (Model_Processor().formatNumber(list_priceDom[0], "co.uk").isdigit()):
                                            item['list_price'] = Model_Processor().formatNumber(list_priceDom[0], "co.uk")
                                except:
                                ...
                                try:
                                    ...
                                    if (ratingDom):
                                        item['rating'] = Model_Processor().formatRating(ratingDom[0], "co.uk")
                                except:
            ...
            if (totalDom):
                # 总数 >1
                total = Model_Processor().formatNumber(totalDom[0].split(" ")[2], "co.uk")
                if (total.isdigit()):
                    total = {"total": total}
                    data.append(total)
                else:
                    # 总数 ==1
                    total = Model_Processor().formatNumber(totalDom[0].split(" ")[0], "co.uk")
                    if (total == "one"):
                        total = "1"
                    if (total.isdigit()):
                        total = {"total": total}
