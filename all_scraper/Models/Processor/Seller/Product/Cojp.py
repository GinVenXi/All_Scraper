...
class Model_Processor_Seller_Product_Cojp(Model_Processor):
    def __init__(self):
        pass
        ...
        if (listDoms):
            for itemDom in listDoms:
                ...
                try:
                    ...
                    if (ratingDom):
                        item['seller_rating'] = Model_Processor().formatRating(ratingDom[0], "co.jp")
                ...
                # 抓取bestseller
                try:
                    bestsellerDom = itemDom.xpath("div//span[contains(@class, 'sx-bestseller')]/a/@href")
