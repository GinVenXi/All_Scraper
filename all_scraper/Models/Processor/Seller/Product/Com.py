...
class Model_Processor_Seller_Product_Com(Model_Processor):
    def __init__(self):
        pass
    ...
    def process(self, html):
        ...
        if (listDoms):
            for itemDom in listDoms:
                ...
                # 抓取price
                try:
                    priceDom = itemDom.xpath("div//span[contains(@class, 'sx-zero-spacing')]/@aria-label")
                    if (priceDom):
                ...
                try:
                    ...
                    if (ratingDom):
                        item['seller_rating'] = Model_Processor().formatRating(ratingDom[0], "com")
