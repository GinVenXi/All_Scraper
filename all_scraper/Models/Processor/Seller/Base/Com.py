...
class Model_Processor_Seller_Base_Com(Model_Processor):
    def __init__(self):
        pass
    ...
    def process(self, html):
        ...
        try:
            ...
            if (ratingDom):
                data['rating'] = Model_Processor().formatRating(ratingDom[0], "com")
        except:
                    ...
                    if (typeDom):
                        ...
                        if (thirtyDaysDom):
                            ...
                            if (thirtyDaysDom[0].strip() != '-'):
                                thirtyDaysDom = Model_Processor().formatNumber(thirtyDaysDom[0].strip(), "com")
                        ...
                        if (nintyDaysDom):
                            ...
                            if (nintyDaysDom[0].strip() != '-'):
                                nintyDaysDom = Model_Processor().formatNumber(nintyDaysDom[0].strip(), "com")
                        ...
                        if (twelveMonthsDom):
                            ...
                            if (twelveMonthsDom[0].strip() != '-'):
                                twelveMonthsDom = Model_Processor().formatNumber(twelveMonthsDom[0].strip(), "com")
                        ...
                        if (lifetimeDom):
                            ...
                            if (lifetimeDom[0].strip() != '-'):
                                lifetimeDom = Model_Processor().formatNumber(lifetimeDom[0].strip(), "com")
