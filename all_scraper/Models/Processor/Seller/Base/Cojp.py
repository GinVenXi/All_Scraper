...
class Model_Processor_Seller_Base_Cojp(Model_Processor):
    def __init__(self):
        pass
    ...
    def process(self, html):
        ...
        try:
            ...
            if (ratingDom):
                data['rating'] = Model_Processor().formatRating(ratingDom[0], "co.jp")
        except:
                    ...
                    if (typeDom):
                        ...
                        if (thirtyDaysDom):
                            ...
                            if (thirtyDaysDom[0].strip() != '-'):
                                thirtyDaysDom = Model_Processor().formatNumber(thirtyDaysDom[0].strip(), "co.jp")
                        ...
                        if (nintyDaysDom):
                            ...
                            if (nintyDaysDom[0].strip() != '-'):
                                nintyDaysDom = Model_Processor().formatNumber(nintyDaysDom[0].strip(), "co.jp")
                        ...
                        if (twelveMonthsDom):
                            ...
                            if (twelveMonthsDom[0].strip() != '-'):
                                twelveMonthsDom = Model_Processor().formatNumber(twelveMonthsDom[0].strip(), "co.jp")
                        ...
                        if (lifetimeDom):
                            ...
                            if (lifetimeDom[0].strip() != '-'):
                                lifetimeDom = Model_Processor().formatNumber(lifetimeDom[0].strip(), "co.jp")
