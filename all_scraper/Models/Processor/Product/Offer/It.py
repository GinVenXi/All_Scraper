...
class Model_Processor_Product_Offer_It(Model_Processor):
    def __init__(self):
        pass

    def process(self, html):
        if html == '' or html == 'None':
            print "Can't get them html from https://www.amazon.it/offerlist"
            sys.exit()
        ...
        for itemDom in div:
                ...
                try:
                    ...
                    if (shipping1):
                        ...
                        if(shipping1):
                            ...
                            shipping1 = itemDom.xpath("div//p[contains(@class, 'olpShippingInfo')]/span/span/text()")
                            if (shipping1):
                                ship1 = shipping1[0].strip()
                ...
                try:
                    ...
                    if (shipping2 and shipping2 != '' and shipping2[0].strip() != ""):
                        ...
                        if(shipping2):
                            ...
                            shipping2 = itemDom.xpath("div//p[contains(@class, 'olpShippingInfo')]/span/span/text()")
                            if (shipping2):
                                ship2 = shipping2[1].strip()
                except Exception as err:
                    print (err)
                if(ship1 and ship2):
                    if ("GRATUITA" in ship1):
            ...
            try:
                ...
                if (fulfillment):
                    if (fulfillment[0].strip() == 'Spedito da Amazon'):
            ...
            try:
                ...
                if (seller_rating):
                    data['seller_rating'] = self.formatRating(seller_rating[0].strip(), "it")
            ...
            try:
                ...
                if (seller_rating_count):
                    try:
                        ...
                        rating_count = self.formatSellerRatingCount(seller_rating_count[2].strip().split("(")[1].replace(")", "").strip(), "it")
                    except:
                        pass
            ...
            try:
                ...
                if (seller_positive):
                    if (seller_positive[0].strip() != ""):
                        if (self.formatPositive(seller_positive[0].replace(".", "").strip(), "it").isdigit()):
                            data['seller_positive'] = self.formatPositive(seller_positive[0].replace(".", "").strip(), "it")
                # else:
