...
class Model_Processor_Product_Offer_Com(Model_Processor):
    def __init__(self):
        pass
    ...
    def process(self, html):
        ...
        for itemDom in div:
            ...
            try:
                ...
                if (seller_rating):
                    data['seller_rating'] = self.formatRating(seller_rating[0].strip(), "com")
            ...
            try:
                ...
                if (seller_rating_count):
                    try:
                        rating_count = self.formatSellerRatingCount(seller_rating_count[2].strip().split(".")[1], "com").strip()
                    except:
                        pass
            ...
            try:
                ...
                if (seller_positive):
                    if (seller_positive[0].strip()):
                        if (self.formatPositive(seller_positive[0].replace(".", "").strip(), "com").isdigit()):
                            data['seller_positive'] = self.formatPositive(seller_positive[0].replace(".", "").strip(), "com")
