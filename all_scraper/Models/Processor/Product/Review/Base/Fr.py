...
#############################################################
'''
class Model_Processor_Product_Review_Base_Fr(Model_Processor):
        ...
        if (crDom):
            ...
            if (detailDom):
                ...
                try:
                    ...
                    if (authorDom):
                        ...
                        if ("profile" in authorLink[0]):
                            ...
                            if (data['author_id']):
                                # author_url 6
                                data['author_url'] = "http://www.amazon.fr/gp/pdp/profile/"+data['author_id']
                ...
                try:
                    ...
                    if (reviewDateDom):
                        data['date'] = self.formatReviewDate(reviewDateDom[0], "fr")
                        # print (data['date'])
                except:
                    pass
                # rating 8
            ...
            try:
                ...
                if (verifiedDom):
                    # print (verifiedDom[0])
                    if (verifiedDom[0].strip() == "Achat v̩rifi̩"):
                        data['verified'] = 1
                        # print (data['verified'])
            except:
                pass
