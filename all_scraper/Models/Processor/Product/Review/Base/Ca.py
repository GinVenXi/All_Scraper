...
#############################################################
'''
class Model_Processor_Product_Review_Base_Ca(Model_Processor):
        ...
        if (crDom):
            ...
            if (detailDom):
                ...
                try:
                    ...
                    if (authorDom):
                        ...
                        if ("profile" in authorLink[0]):
                            ...
                            if (data['author_id']):
                                # author_url 6
                                data['author_url'] = "http://www.amazon.ca/gp/pdp/profile/"+data['author_id']
                ...
                try:
                    ...
                    if (reviewDateDom):
                        data['date'] = self.formatDate(reviewDateDom[0], "ca")
                        # print (data['date'])
                except:
                    pass
                # rating 8
