...
class Model_Processor_MobileProduct_Base_Couk(Model_Processor):
        ...
        try:
            ...
            for i in data['results']['sections'][0]['items']:
                ...
                try:
                    ...
                    pass
                try:
                    item['first_available_date'] = self.formatDate(i['releaseDate'], region)
                    # print (item['first_available_date'])
                except:
                    pass
                # try:
