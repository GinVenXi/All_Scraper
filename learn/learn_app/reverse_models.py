...
class JdKeywords(models.Model):
    keyword = models.CharField(max_length=45)
    sku = models.CharField(max_length=45, blank=True, null=True)
    productpage_url = models.CharField(max_length=1000, blank=True, null=True)
    page_id = models.IntegerField(blank=True, null=True)
    page_position = models.IntegerField(blank=True, null=True)
    last_update_time = models.DateTimeField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'jd_keywords'


class JdProductReview(models.Model):
    reviewer_name = models.CharField(max_length=45, blank=True, null=True)
    reviewer_id = models.CharField(max_length=45, blank=True, null=True)
    product_information = models.CharField(max_length=255, blank=True, null=True)
    review_content = models.CharField(max_length=2550, blank=True, null=True)
    review_time = models.CharField(max_length=45, blank=True, null=True)
    product_id = models.CharField(max_length=45, blank=True, null=True)
    review_json_link = models.CharField(max_length=1000, blank=True, null=True)
    review_count = models.CharField(max_length=45, blank=True, null=True)
    goodrate = models.CharField(max_length=45, blank=True, null=True)
    poor_count = models.CharField(max_length=45, blank=True, null=True)
    general_count = models.CharField(max_length=45, blank=True, null=True)
    good_count = models.CharField(max_length=45, blank=True, null=True)
    last_update_time = models.DateTimeField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'jd_product_review'
...
class JdProducts(models.Model):
    ...
    shop_id = models.CharField(max_length=45, blank=True, null=True)
    shop_link = models.CharField(max_length=1000, blank=True, null=True)
    price = models.CharField(max_length=45, blank=True, null=True)
    review_count = models.CharField(max_length=45, blank=True, null=True)
    sellerpage_url = models.CharField(max_length=255)
    shipping = models.CharField(max_length=45, blank=True, null=True)
    shop_score = models.CharField(max_length=45, blank=True, null=True)
...
class SinaDownloadQueue(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'sina_download_queue'


class SinaPages(models.Model):
    url_id = models.CharField(unique=True, max_length=64)
    title = models.CharField(max_length=255)
    url = models.CharField(max_length=255)
...
class TaobaoKeywords(models.Model):
    product_id = models.CharField(max_length=45)
    keyword = models.CharField(max_length=45)
    seller_id = models.CharField(max_length=45)
    productpage_url = models.CharField(max_length=255, blank=True, null=True)
    page_id = models.IntegerField(blank=True, null=True)
    page_position = models.IntegerField(blank=True, null=True)
    time = models.DateTimeField(blank=True, null=True)
    last_update_time = models.DateTimeField(blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'taobao_keywords'


class TaobaoProductImage(models.Model):
    product_id = models.CharField(max_length=45, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'taobao_product_image'


class TaobaoProductReview(models.Model):
    reviewer_name = models.CharField(max_length=45, blank=True, null=True)
    reviewer_id = models.CharField(max_length=45, blank=True, null=True)
    product_information = models.CharField(max_length=255, blank=True, null=True)
    review_content = models.CharField(max_length=2550, blank=True, null=True)
    review_time = models.CharField(max_length=45, blank=True, null=True)
    review_json_link = models.CharField(max_length=1000, blank=True, null=True)
    seller_id = models.CharField(max_length=45, blank=True, null=True)
    append_comment = models.CharField(max_length=2550, blank=True, null=True)
    review_count = models.CharField(max_length=45, blank=True, null=True)
    image_count = models.CharField(max_length=45, blank=True, null=True)
    last_update_time = models.DateTimeField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'taobao_product_review'


class TaobaoProductReviewImage(models.Model):
    reviewer_name = models.CharField(max_length=45, blank=True, null=True)
    reviewer_id = models.CharField(max_length=45, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'taobao_product_review_image'


class TaobaoProducts(models.Model):
    product_id = models.CharField(max_length=45, blank=True, null=True)
    title = models.CharField(max_length=255, blank=True, null=True)
    shop_name = models.CharField(max_length=255, blank=True, null=True)
    shop_location = models.CharField(max_length=45, blank=True, null=True)
    before_price = models.CharField(max_length=45, blank=True, null=True)
    current_price = models.CharField(max_length=45, blank=True, null=True)
    shipping = models.CharField(max_length=45, blank=True, null=True)
    discription = models.CharField(max_length=45, blank=True, null=True)
    service = models.CharField(max_length=45, blank=True, null=True)
    logistics = models.CharField(max_length=45, blank=True, null=True)
    sell_count = models.CharField(max_length=45, blank=True, null=True)
    collect_count = models.CharField(max_length=45, blank=True, null=True)
    review_count = models.CharField(max_length=45, blank=True, null=True)
    shop_link = models.CharField(max_length=255, blank=True, null=True)
    sellerpage_url = models.CharField(max_length=255, blank=True, null=True)
    time = models.DateTimeField(blank=True, null=True)
    last_update_time = models.DateTimeField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'taobao_products'


class TaobaoSellerPage(models.Model):
    seller_name = models.CharField(max_length=45, blank=True, null=True)
    seller_id = models.CharField(max_length=45, blank=True, null=True)
    seller_location = models.CharField(max_length=45, blank=True, null=True)
    seller_credit = models.CharField(max_length=45, blank=True, null=True)
    seller_conform = models.CharField(max_length=45, blank=True, null=True)
    seller_service = models.CharField(max_length=45, blank=True, null=True)
    seller_logistics = models.CharField(max_length=45, blank=True, null=True)
    favorable_rate = models.CharField(max_length=45, blank=True, null=True)
    csspeed = models.CharField(max_length=45, blank=True, null=True)
    csrate = models.CharField(max_length=45, blank=True, null=True)
    dispute_rate = models.CharField(max_length=45, blank=True, null=True)
    penalty_num = models.CharField(max_length=45, blank=True, null=True)
    seller_page_link = models.CharField(max_length=45, blank=True, null=True)
    time = models.DateTimeField(blank=True, null=True)
    last_update_time = models.DateTimeField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'taobao_seller_page'


class TencentDownloadQueue(models.Model):
    url_id = models.CharField(max_length=64)
    title = models.CharField(max_length=255)
    url = models.CharField(max_length=255)
    type = models.CharField(max_length=64)
    ...
    class Meta:
        managed = False
        db_table = 'tencent_download_queue'


class TencentPages(models.Model):
    url_id = models.CharField(unique=True, max_length=64)
    title = models.CharField(max_length=255)
    url = models.CharField(max_length=255)
    summary = models.CharField(max_length=500, blank=True, null=True)
    keywords = models.CharField(max_length=255, blank=True, null=True)
    review_count = models.IntegerField(blank=True, null=True)
    review_link = models.CharField(max_length=255, blank=True, null=True)
    published_time = models.DateTimeField()
    last_updated_time = models.DateTimeField()

    class Meta:
        managed = False
        db_table = 'tencent_pages'
